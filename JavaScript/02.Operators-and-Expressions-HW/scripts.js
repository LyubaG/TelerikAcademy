...
function problem1() {
    ...
    if (!isNaN(problem1Input) && problem1Input % 1 === 0 && problem1Input !== '') {
        if (problem1Input % 2 === 0) {
            ...
            console.log('Problem 1: ' + problem1Input + ' is EVEN');
        } else {
            isOdd = true;
            document.getElementById('pr1answer').innerHTML =
                problem1Input + ' is ODD';
            console.log('Problem 1: ' + problem1Input + ' is ODD');
        }
    } else {
        document.getElementById('pr1answer').innerHTML =
...
// Function for padding a string left with 'num' characters 'ch', useful for binary nums
...
// Problem 6
function problem6() {
    var coorX = document.getElementById('pt-x').value,
        coorY = document.getElementById('pt-y').value,
        r = 5,
