namespace CompareSimpleMath
{
    ...
    public class PerformanceSimpleMath
    {
        const int IterationCount = (int)1E8; // 100,000,000
        ...
        {
            // The 'checked' feature specifies that overflow is an acceptable result of an 
            // operation such as increment—no exception is thrown
            ...
            unchecked
            {
...

                {
                    ...
                    // Getting long here...around 40 seconds
