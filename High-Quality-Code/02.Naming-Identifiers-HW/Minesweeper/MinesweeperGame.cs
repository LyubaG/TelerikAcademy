namespace Minesweeper
{
    ...
    public class MinesweeperGame
    {
        public static void Main()
        {
            ...
            do
            {
                ...
                if (steppedOnAMine)
                {
                    ...
                    Score playerScore = new Score(nickname, pointCount);
                    ...
                    highscores.Sort((Score r1, Score r2) => r2.PlayerPoints.CompareTo(r1.PlayerPoints));
                    ShowHighscores(highscores);
                    playfield = CreatePlayfield();
                    mines = PutMines();
                    pointCount = 0;
        ...
        private static void ShowHighscores(List<Score> highscores)
        {
